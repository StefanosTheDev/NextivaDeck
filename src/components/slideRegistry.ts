...
const SLIDE_COMPONENTS: Record<string, SlideDef> = {
  ...
  "customer-use-cases-new-2026-04": {
    id: "customer-use-cases-new-2026-04",
    label: "Customer Use Cases — New Slide (Apr 2026)",
    component: CustomerUseCasesNewSlide,
    theme: "dark",
    isNew: true,
  },
  "customer-use-cases-followup-2026-04": {
    id: "customer-use-cases-followup-2026-04",
    label: "Customer Use Cases — Follow-up Slide (Apr 2026)",
    component: CustomerUseCasesNewFollowupSlide,
    theme: "dark",
    isNew: true,
  },
