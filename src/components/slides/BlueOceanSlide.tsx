...
const cards = [
  {
    ...
    detail:
      "Most work in centers with fewer than 30 agents — too small for enterprise platforms to care about",
  },
  {
    stat: "Millions",
...
export default function BlueOceanSlide({ slideNumber = 12 }: { slideNumber?: number }) {
  return (
    <div
      className="slide"
      style={{
      ...
      >
        {cards.map((c, i) => (
          ...
          >
            <p
              className="font-heading"
              style={{ fontSize: 72, fontWeight: 700, color: "#FFFFFF", margin: 0, lineHeight: 1 }}
            >
              {c.stat}
            </p>
            <p
