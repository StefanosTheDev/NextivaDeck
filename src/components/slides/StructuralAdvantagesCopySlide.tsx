...
const pillars = [
  ...
  },
  {
    ...
    points: [
      "Real-time, proprietary interaction data",
      "Ground truth for AI decisioning",
      "Value compounds with every customer interaction",
    ],
...
export default function StructuralAdvantagesCopySlide({ slideNumber = 45 }: { slideNumber?: number }) {
  return (
    <div
      className="slide"
      style={{
