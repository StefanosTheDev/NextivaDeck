  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="font-heading" style={{ fontSize: 48, fontWeight: 500, color: "#FFFFFF", margin: "0 auto", lineHeight: 1.18, whiteSpace: "nowrap" }}>
      ...
      >
        <div style={{ position: "relative", width: DIAMOND.w, height: DIAMOND.h }}>
          ...
          >
            <defs>
              <marker id="arrowDottedCopy" markerWidth="14" markerHeight="10" refX="12" refY="5" orient="auto">
                <path d="M0,0 L14,5 L0,10" fill="#7EB3E8" stroke="none" />
              </marker>
              <marker id="arrowThickCopy" markerWidth="10" markerHeight="8" refX="9" refY="4" orient="auto">
                <path d="M0,0 L10,4 L0,8" fill="#7EB3E8" stroke="none" />
              </marker>
            </defs>

            {/* Live conversation → AI (dotted, arrow at AI end) */}
            <line
              x1={LEFT.x + 130} y1={LEFT.y - 20}
              x2={AI.x - 70} y2={AI.y + 55}
              stroke="#7EB3E8" strokeWidth="2.5" strokeDasharray="8 5" opacity="0.75"
              markerEnd="url(#arrowDottedCopy)"
            />

            {/* Static data from Siloed Systems → AI (dotted, arrow at AI end) */}
            <line
          ...
          <div style={{
            ...
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.5)", lineHeight: 1.5, margin: 0 }}>
              Including historical conversation context, intent, and behavior.
            </p>
          </div>

          {/* Static data from Siloed Systems — right */}
          <div style={{
            position: "absolute",
            ...
            <h3 className="font-heading" style={{ fontSize: 26, fontWeight: 700, color: "#FFFFFF", margin: "0 0 6px", lineHeight: 1.2 }}>
              Static data from Siloed Systems
            </h3>
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.5)", lineHeight: 1.5, margin: 0 }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.5)", lineHeight: 1.5, margin: 0 }}>
              Ability to synthesize and drive workflows based on holistic context.
            </p>
          </div>
        </div>
      </motion.main>
