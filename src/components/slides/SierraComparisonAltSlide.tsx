...
const ROWS: RatedRow[] = [
  {
    ...
    icon: Layers,
    competitorFill: 1,
    competitorLabel: "AI agent layer only — no comms backbone",
    nextivaFill: 4,
  ...
  },
  {
    ...
    icon: Database,
    competitorFill: 3,
    competitorLabel: "Strong models + memory; siloed from human agents",
    nextivaFill: 4,
  ...
  },
  {
    ...
    icon: Globe,
    competitorFill: 2,
    competitorLabel: "$150M ARR; concentrated in retail/consumer",
    nextivaFill: 4,
  ...
  },
  {
    ...
    icon: Workflow,
    competitorFill: 2,
    competitorLabel: "Custom SDK per customer; no unified inbox",
    nextivaFill: 3,
  ...
  },
  {
    ...
    icon: Building2,
    competitorFill: 2,
    competitorLabel: "100+ enterprise customers; VC-funded growth",
    nextivaFill: 4,
    nextivaLabel: "92K+ accounts, profitable, diversified base",
  },
];
...
export default function SierraComparisonAltSlide({
  slideNumber = 0,
}: {
  slideNumber?: number;
}) {
      ...
      >
        ...
        >
          ...
          >
            ...
            <img
              src="/logos/competitors/agentic/TR__sierra.png"
              alt="Sierra"
      ...
      >
        ...
        >
          ...
          >
            ...
            the buyer needs AI agents embedded in an existing comms platform —
            not a standalone AI layer that requires a separate contact center.
          </p>
        </div>
      </motion.div>
