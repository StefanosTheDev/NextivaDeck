...
const chapters = [
  {
    ...
    bullets: [
      "Pioneered cloud communications with customer management at scale.",
      "Won through product simplicity, amazing service, and reliability.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Developed natively on our infrastructure and data layer — not bolted on",
      "From assist → autopilot → fully autonomous execution across CX workflows",
    ],
