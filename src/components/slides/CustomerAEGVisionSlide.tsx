        ...
        <CustomerSlideSbStyleHeroCardsRow
          ...
          hero={
            <CustomerEnterpriseHeroColumn
              ...
              imageSrc="/images/pptx-slides/slide11-img0.png"
              imageAlt="AEG Vision"
              industryPillLabel="Retail Optometry"
              pillBackground="#7B6BA8"
              metaLine="500 Clinical Practice Locations · 5,000 employees"
              objectFit="cover"
