...
export default function FutureStrategicPlanningCoverSlide({
  slideNumber: _sn,
}: {
  slideNumber?: number;
}) {
  return (
    ...
    >
      ...
      >
        ...
        >
          Where we&apos;re placing our growth bets — and what we&apos;ll prove along the way.
        </motion.p>
      ...
      >
        Strategic Planning · Nextiva FY27
      </footer>
    </div>
  );
}
