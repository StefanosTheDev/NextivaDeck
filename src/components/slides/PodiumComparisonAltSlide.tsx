...
const ROWS: RatedRow[] = [
  {
    ...
    icon: Layers,
    competitorFill: 1,
    competitorLabel: "Text inbox + reviews + payments",
    nextivaFill: 4,
  ...
  },
  {
    ...
    icon: Database,
    competitorFill: 2,
    competitorLabel: "Vertical playbooks on 3rd-party models",
    nextivaFill: 4,
  ...
  },
  {
    ...
    icon: Radio,
    competitorFill: 1,
    competitorLabel: "Text-first; voice is a bolt-on receptionist",
    nextivaFill: 4,
  ...
  },
  {
    ...
    icon: Workflow,
    competitorFill: 3,
    competitorLabel: "Fast SMB self-serve; shallow SoR integrations",
    nextivaFill: 3,
  ...
  },
  {
    ...
    icon: Building2,
    competitorFill: 2,
    competitorLabel: "~74% of customers are 2–50 employees",
    nextivaFill: 4,
    nextivaLabel: "92K+ accounts, <0.6% concentration",
  },
];
...
export default function PodiumComparisonAltSlide({
  slideNumber = 0,
}: {
  slideNumber?: number;
}) {
      ...
      >
        ...
        >
          ...
          >
            ...
            <img
              src="/logos/competitors/agentic/BR__podium.png"
              alt="Podium"
              style={{
                maxHeight: 30,
                maxWidth: 180,
      ...
      >
        ...
        >
          ...
          >
            ...
            the buyer needs voice, digital, and AI agents on one platform — at
            enterprise scale — not a text-first tool built for a 10-seat local
            business.
          </p>
        </div>
      </motion.div>
