            ...
            <div style={{ flex: 1, minHeight: 0, position: "relative" }}>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={revPerHeadData} margin={{ top: 12, right: 24, left: 36, bottom: 12 }}>
                  ...
                  />
                  <Line type="monotone" dataKey="value" stroke="#5BA0E8" strokeWidth={4} dot={{ r: 6, fill: "#5BA0E8", strokeWidth: 1.5, stroke: "rgba(255,255,255,0.4)" }} name="Rev / Head" isAnimationActive={false}>
                  ...
                  <Line type="monotone" dataKey="rdValue" stroke="#7EB3E8" strokeWidth={4} dot={{ r: 6, fill: "#7EB3E8", strokeWidth: 1.5, stroke: "rgba(255,255,255,0.4)" }} strokeDasharray="6 4" name="Rev / R&D Head" isAnimationActive={false}>
