...
function getSegments(slideId?: string): Segment[] {
  // Investor-only variant: this slide is the "…-end" copy, so it should
  // show the middle tiers under "The Massive Middle" both when invoked
  // under the original shared id and under the investor-only id.
  const showMiddleTiers =
    slideId === "agentic-opp-yaniv-vh-end" ||
    slideId === "agentic-opp-yaniv-vh-end-investor";
  return [
    {
      value: "6M",
      flex: 6,
...
export default function AgenticOpportunityYanivVHInvestorSlide({
  slideNumber = 12,
  slideId,
}: {
  slideNumber?: number;
