...
export default function FutureSessionAgendaCoverSlide({
  slideNumber: _sn,
}: {
  slideNumber?: number;
}) {
  return (
    ...
    >
      ...
      >
        ...
        >
          <ClipboardList size={46} color={BLUE} strokeWidth={2} />
        </motion.div>
        ...
        >
          ...
          <strong style={{ color: NAVY_DARK, fontWeight: 700 }}>
            topics, outputs, and the decisions we leave with.
          </strong>
        </motion.p>
