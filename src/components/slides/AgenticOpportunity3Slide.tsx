...
const competitiveBullets = [
  ...
  "These businesses lack IT teams — they cannot vibe-code alternatives",
];

const whyNextiva = [
  "Deep Communications Infrastructure",
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 18, color: "rgba(255,255,255,0.45)", margin: "10px 0 0", lineHeight: 1.5 }}>
          Millions of customer interactions will be handled by AI — but only on platforms with the infrastructure and data to deliver it.
        </p>
      </motion.header>
      ...
      <motion.div
        ...
        style={{ padding: "20px 80px 0", position: "relative", marginTop: "auto" }}
      >
      ...
      <motion.main
        ...
        style={{ display: "flex", gap: 16, padding: "16px 80px 0", alignItems: "stretch", marginTop: "auto" }}
      >
        {/* Market Context */}
        <div style={{
