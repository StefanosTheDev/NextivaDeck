...
const PILLAR_NUM = "01";
const PILLAR_LABEL = "Strategic Pillar 01";
const PILLAR_TITLE = "Grow the Base";
...
const SUPPORTING = [
  {
    ...
    body: (
      <>
        ...
        to an{" "}
        <strong style={{ color: NAVY_DARK, fontWeight: 700 }}>expansion mindset</strong>{" "}
        across the installed base.
      </>
    ),
  },
  {
    eyebrow: "Key product levers",
    body: (
      <>
        Leverage the full{" "}
        <strong style={{ color: NAVY_DARK, fontWeight: 700 }}>product portfolio</strong> —
        pick the right products and invest behind them to penetrate existing customers.
      </>
    ),
  },
  {
    eyebrow: "Tactical & Go-to-Market",
    body: (
      <>
        Find{" "}
        <strong style={{ color: NAVY_DARK, fontWeight: 700 }}>
        ...
        supported by product, BT, sales and ops to penetrate a large percentage of the installed base.
      </>
    ),
  },
];

export default function FutureGrowTheBaseCoverSlide({
  slideNumber: _sn,
}: {
  slideNumber?: number;
}) {
  return (
    <div className="slide" style={{ background: "#FFFFFF", color: NAVY_DARK }}>
      ...
      >
        Strategic Reframe · Pillar 01 of 03
      </footer>
    </div>
  );
}
