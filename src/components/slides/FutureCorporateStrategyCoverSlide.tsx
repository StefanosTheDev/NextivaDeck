...
export default function FutureCorporateStrategyCoverSlide({
  slideNumber: _sn,
}: {
  slideNumber?: number;
}) {
  return (
    ...
    >
      ...
      >
        ...
        >
          <Target size={46} color={BLUE} strokeWidth={2} />
        </motion.div>
        ...
        >
          ...
          <strong style={{ color: NAVY_DARK, fontWeight: 700 }}>
            activate the base, modernize the operation, accelerate new growth.
          </strong>
        </motion.p>
      ...
      >
        Corporate Strategy · Nextiva FY26
      </footer>
    </div>
  );
}
