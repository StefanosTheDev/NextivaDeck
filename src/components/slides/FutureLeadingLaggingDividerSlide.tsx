...
export default function FutureLeadingLaggingDividerSlide({
  slideNumber: _sn,
}: {
  slideNumber?: number;
}) {
  return (
    ...
    >
      ...
      >
        ...
        >
          <LineChart size={52} color={BLUE} strokeWidth={2} />
        </motion.div>
        ...
        >
          What we&apos;re building toward — and what we&apos;re already delivering.
        </motion.p>
