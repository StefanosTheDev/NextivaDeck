...
const avoid = [
  "Deal sizes often do not support a traditional sales force",
  "Customers still require guidance and reassurance",
  "Human support increases acquisition costs",
  "Low-cost self-serve models often fail to convert these buyers",
];

const result = [
  "Push customers into e-commerce",
  "Outsource sales",
  "Ignore the segment entirely",
  "Focus only on larger enterprise accounts",
];
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
      {items.map((t, i) => (
        ...
        >
          ...
          <p style={{ margin: 0, fontSize: 17, lineHeight: 1.5, color: "rgba(255,255,255,0.82)", fontWeight: 400 }}>
            {t}
          </p>
        </motion.div>
      ))}
...
export default function MiddleMarketDifficultProfitablySlide({ slideNumber = 0 }: { slideNumber?: number }) {
  return (
    <div className="slide" style={{ background: BG, overflow: "hidden", position: "relative" }}>
      ...
      >
        ...
        >
          The middle market is operationally difficult and economically unattractive for most competitors
        </h1>
        ...
        >
          <p style={{ fontSize: 18, color: "rgba(255,255,255,0.68)", margin: 0, lineHeight: 1.55, fontWeight: 400 }}>
            Customers in this segment are too small for a traditional enterprise sales model. This creates an unattractive segment for most competitors.{" "}
            <strong style={{ fontWeight: 700, color: "#FFFFFF" }}>This is where Nextiva wins.</strong>
          </p>
        </motion.div>
      </motion.header>
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 20 }}>
            ...
            >
              <AlertTriangle size={24} color="#FBBF24" strokeWidth={1.75} />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                Structural friction in the segment
              </p>
            </div>
          </div>
          <div style={{ paddingLeft: 10 }}>
            <FrameworkRows items={avoid} accent="#FBBF24" grayNumbers />
          </div>
        </motion.section>
        ...
        >
          <div style={{ width: 1, flex: 1, minHeight: 48, background: "linear-gradient(180deg, transparent, rgba(255,255,255,0.12), transparent)" }} />
          <div
            style={{
              width: 44,
              height: 44,
        ...
        >
          <div style={{ display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 20 }}>
            ...
            >
              <CircleDot size={24} color="#7EB3E8" strokeWidth={1.75} />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ margin: 0, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.45)" }}>
                Competitive outcome
              ...
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.52)", margin: "10px 0 18px", lineHeight: 1.45, fontWeight: 500 }}>
                Most competitors either:
              </p>
            </div>
          </div>
          <div style={{ paddingLeft: 10 }}>
            <FrameworkRows items={result} accent="#7EB3E8" />
          </div>
        </motion.section>
      </main>
