...
const ROWS: RatedRow[] = [
  {
    ...
    icon: Layers,
    competitorFill: 2,
    competitorLabel: "Messaging + ticketing + Fin AI bot",
    nextivaFill: 4,
  ...
  },
  {
    ...
    icon: Database,
    competitorFill: 2,
    competitorLabel: "Fin trained on help center; $0.99/resolution",
    nextivaFill: 4,
    nextivaLabel: "10B+ interaction data moat, CRM-grounded",
  },
  {
    dimension: "Voice + digital",
    icon: Radio,
    competitorFill: 1,
    competitorLabel: "Chat + email only; no native voice channel",
    nextivaFill: 4,
    nextivaLabel: "One routing engine, single record, all channels",
  },
  {
    dimension: "Deployment",
    icon: Workflow,
    competitorFill: 3,
    competitorLabel: "Fast SMB self-serve; no multi-agent orchestration",
    nextivaFill: 3,
    nextivaLabel: "Enterprise integrations; 83% annual contracts",
  },
  {
    dimension: "Scale & fit",
    icon: Building2,
    competitorFill: 2,
    competitorLabel: "Tech/SaaS mid-market; costs balloon at scale",
    nextivaFill: 4,
    nextivaLabel: "92K+ accounts, carrier-class infrastructure",
  },
];
...
export default function IntercomComparisonAltSlide({
  slideNumber = 0,
}: {
  slideNumber?: number;
}) {
  return (
    ...
    >
      ...
      >
        ...
        >
          COMPETITIVE LANDSCAPE — SYSTEM OF ENGAGEMENT
        </p>
        <h1
      ...
      >
        ...
        >
          ...
          >
            ...
            <img
              src="/logos/competitors/agentic/BR__intercom.png"
              alt="Intercom"
      ...
      >
        ...
        >
          ...
          >
            ...
            the buyer needs a full CX platform — not a chat widget with
            per-resolution billing that stops at the help center.
          </p>
        </div>
      </motion.div>
