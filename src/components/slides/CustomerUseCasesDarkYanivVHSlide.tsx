...
const customers = [
  {
    ...
    solutions: [
      "XBert AI IVA routes callers by intent — replacing static IVR",
      "Predictive Dialer achieves speed-to-lead under 5 min; booking 35% → 60%",
      "Auto transcription + Service Titan API eliminates manual logging",
      "Sticky agent routing drives 40% same-day close rate",
    ],
    metrics: [
  ...
  },
  {
    ...
    solutions: [
      "Geo + time-of-day routing across 3 regions ensures correct office",
      "XBert AI with 1K sessions/mo handles routing without humans",
      "Unified platform replacing Momentum + WebEx for all 7 locations",
      "Omnichannel expansion adds SMS, web chat, and callback options",
    ],
    metrics: [
  ...
  },
  {
    ...
    solutions: [
      "AI handles top 3 call reasons — freeing staff from repetitive calls",
      "AI script analysis flags underperformers for targeted training",
      "Tiered supervisor dashboards with per-agent stats",
      "CRM integration via Dialogflow replaces Excel-based tracking",
    ],
    metrics: [
      { stat: "$5.2K", label: "MRR" },
      { stat: "$205K", label: "TCV" },
...
export default function CustomerUseCasesDarkYanivVHSlide({ slideNumber = 0 }: { slideNumber?: number }) {
  return (
    <div
      className="slide"
      style={{
