...
const competitiveBullets = [
  ...
  "These businesses lack IT teams — they cannot build or maintain their own alternatives",
];
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 18, color: "rgba(255,255,255,0.45)", margin: "10px 0 0", lineHeight: 1.5 }}>
          30 to 50% of interactions will be automated within five years — but only platforms with infrastructure, data, and compliance can deliver it.
        </p>
      </motion.header>
