...
export default function SolutionDarkSlide({ slideNumber = 9 }: { slideNumber?: number }) {
  return (
    <div className="slide slide--dark" style={{ justifyContent: "space-between" }}>
      <motion.header
      ...
      >
        <p style={{
          ...
          textTransform: "uppercase", color: "#5B9BF0", margin: "0 0 14px",
        }}>
          OUR SOLUTION
        </p>
        <h1 className="font-heading" style={{ fontSize: 60, fontWeight: 500, color: "#FFFFFF", margin: "0 auto", lineHeight: 1.15, maxWidth: 900 }}>
      ...
      >
        <div style={{ position: "relative", width: DIAMOND.w, height: DIAMOND.h }}>
          ...
          >
            <defs>
              <marker id="arrowThinDark" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto">
                <path d="M0,0 L8,3 L0,6" fill="#5B9BF0" stroke="none" />
              </marker>
              <marker id="arrowThickDark" markerWidth="10" markerHeight="8" refX="9" refY="4" orient="auto">
                <path d="M0,0 L10,4 L0,8" fill="#5B9BF0" stroke="none" />
              </marker>
            </defs>
            ...
            <line
              ...
              stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" strokeDasharray="6 4" opacity="0.6"
              markerEnd="url(#arrowThinDark)"
            />
            ...
            <line
              ...
              stroke="rgba(255,255,255,0.6)" strokeWidth="2.5" opacity="0.8"
              markerEnd="url(#arrowThickDark)"
            />
          </svg>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  background: "radial-gradient(circle at 50% 40%, #3B7DE8 0%, #2860B2 100%)",
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
              {leftIcons.map((Icon, i) => (
                <Icon key={i} size={18} color="rgba(255,255,255,0.5)" strokeWidth={1.75} />
              ))}
            </div>
        ...
        <div style={{
          ...
          {outcomes.map((o, i) => (
            <span key={o} style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <span style={{ fontSize: 16, fontWeight: 700, color: "#5B9BF0" }}>{o}</span>
              {i < outcomes.length - 1 && (
