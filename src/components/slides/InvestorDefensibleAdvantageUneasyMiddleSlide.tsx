...
export default function InvestorDefensibleAdvantageUneasyMiddleSlide({ slideNumber = 0 }: { slideNumber?: number }) {
  return (
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ServiceTitan: another proof point
            </p>
            <div
              style={{
                display: "grid",
            ...
            >
              {[
                { value: "~$108K", label: "ACV / customer", note: "FY26" },
                { value: "~110%", label: "Net Dollar Retention", note: "FY26" },
                { value: "~50%", label: "Pro products attach", note: "Multi-module land" },
              ].map((m) => (
                <div
                  key={m.label}
                  style={{
            ...
            >
              Source: ServiceTitan FY26 disclosures — ARR ~$900M, ~8.5K active customers, NDR ~110%.
            </p>
          </div>
        </motion.section>
      </main>
