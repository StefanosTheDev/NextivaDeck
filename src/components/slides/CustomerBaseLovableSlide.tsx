  ...
  return (
    ...
    >
      ...
      <motion.main
        ...
        style={{ padding: "0 100px", display: "flex", gap: 60, flex: 1, alignItems: "center" }}
      >
          <div style={{ flex: 1 }}>
            ...
            {industries.map((ind) => (
              <div key={ind.name} style={{ marginBottom: 14 }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                  <span style={{ fontSize: 18, color: "rgba(255,255,255,0.6)" }}>{ind.name}</span>
                  <span style={{ fontSize: 18, fontWeight: 600, color: "#FFFFFF" }}>{ind.pct}%</span>
                </div>
                <div style={{ width: "100%", height: 12, background: "rgba(255,255,255,0.1)", borderRadius: 6 }}>
                  <div style={{ width: `${Math.min(ind.pct * 3, 100)}%`, height: "100%", background: "#2860B2", borderRadius: 6 }} />
                </div>
              </div>
            ))}
          </div>
