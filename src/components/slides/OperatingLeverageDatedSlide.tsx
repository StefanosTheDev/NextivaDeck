...
export default function OperatingLeverageDatedSlide({ slideNumber = 29 }: { slideNumber?: number }) {
  return (
    <div
      className="slide"
      style={{
    ...
    >
      ...
      >
        ...
        <h1
          ...
          style={{ fontSize: 64, fontWeight: 400, color: "#FFFFFF", marginTop: 10, lineHeight: 1.15 }}
        >
      ...
      >
        <div style={{ flex: 1, display: "flex", gap: 28, minHeight: 0 }}>
          <div style={{ flex: "0 0 62%", display: "flex", flexDirection: "column", minHeight: 0 }}>
            ...
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.5)", margin: "0 0 4px", lineHeight: 1.4 }}>
            ...
            {topCards.map((c, i) => (
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, margin: "8px 0" }}>
                  <span
                    className="font-heading"
                    style={{ fontSize: 30, fontWeight: 700, color: "rgba(255,255,255,0.5)" }}
                  >
                    {c.from}
                  </span>
                  ...
                  <span className="font-heading" style={{ fontSize: 30, fontWeight: 700, color: "#FFFFFF" }}>
                    {c.to}
                  </span>
                </div>
                <p
                ...
                <p style={{ fontSize: 15, color: "rgba(255,255,255,0.6)", margin: "6px 0 0", lineHeight: 1.4 }}>
                  {c.detail}
                </p>
              </motion.div>
            ))}
